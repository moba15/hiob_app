...
class GraphLine {
  ...
  GraphLine({
      ...
      this.data,
      this.xAxis,
      this.yAxis, this.xAxisId, this.yAxisId, this.minInterval});
  ...
  GraphLine clone() {
    return GraphLine(name: name, type: type, color: color, data: data, dataPoint: dataPoint, background: background, backgroundOpacity: backgroundOpacity,
        showDataDots: showDataDots, xAxis: xAxis, yAxis: yAxis, xAxisId: xAxisId, yAxisId: yAxisId, minInterval: minInterval);
  }
  ...
  factory GraphLine.fromJson(Map<String, dynamic> json, List<GraphAxis> xAxes, List<GraphAxis> yAxes) {
    ...
    return GraphLine(minInterval: json["minInterval"], name: json["name"], type: GraphLineType.values.firstWhere((element) => element.toString() == json["type"] ), color: json["color"], data: json["data"], dataPoint: dataPoint, background: json["background"], backgroundOpacity: json["backgroundOpacity"], yAxisId: json["yAxis"], xAxis: xAxis, yAxis: yAxis, xAxisId: json["xAxis"], showDataDots: json["showDataDots"]);
  }
