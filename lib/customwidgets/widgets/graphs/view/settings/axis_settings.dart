...
class AxisSettingsPage extends StatelessWidget {
  ...
  bool _validate() {
    return graphAxis.dataType != null &&
        graphAxis.description != null &&
        graphAxis.description!.isNotEmpty &&
        (graphAxis.dataInterval ?? 0) >= 0;
  }
      ...
      children: [
        ...
        Expanded(
          child: TextFormField(
            ...
            decoration: const InputDecoration(labelText: "interval (optional)"),
            keyboardType: TextInputType.number,
            inputFormatters: [FilteringTextInputFormatter.digitsOnly],
          ),
        ),
