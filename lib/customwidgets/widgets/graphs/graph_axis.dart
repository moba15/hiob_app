...
enum TimeAxisEnd {
  now,month,day,minute,hour,week,year
}
...
class GraphAxis {
  ...
  GraphAxis clone() => GraphAxis(description: description, dataType: dataType, dataInterval: dataInterval, max: max, min: min, color: color, id: id, timeAxisEnd: timeAxisEnd, scope: scope, scopeUnit: scopeUnit);
  ...
  factory GraphAxis.fromJson(Map<String, dynamic> json) {
    return GraphAxis(id: json["id"], description: json["description"], dataType: AxisDataType.values.firstWhere((element) => element.toString() == json["dataType"]), color: json["color"], dataInterval: json["dataInterval"], max: json["max"], min: json["min"], timeAxisEnd: TimeAxisEnd.values.firstWhere((element) => element.toString() == json["timeAxisEnd"]), scopeUnit: UnitOfTime.values.firstWhere((element) => element.toString() == json["scopeUnit"]), scope: json["scope"]);
  }
