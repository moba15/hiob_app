...
class _$CustomSliderWidgetImpl extends _CustomSliderWidget {
  ...
  @override
  String toString() {
    return 'CustomSliderWidget(type: $type, id: $id, name: $name, dataPoint: $dataPoint, max: $max, min: $min, step: $step, valueMapper: $valueMapper, customPopupmenu: $customPopupmenu)';
  }
