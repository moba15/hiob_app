...
abstract class $CustomMultiselectionWidgetCopyWith<$Res> {
  factory $CustomMultiselectionWidgetCopyWith(
    CustomMultiselectionWidget value,
    $Res Function(CustomMultiselectionWidget) then,
  ) =
      _$CustomMultiselectionWidgetCopyWithImpl<
        $Res,
...
/// @nodoc
class _$CustomMultiselectionWidgetCopyWithImpl<
  $Res,
...
class _$CustomMultiselectionWidgetImpl extends _CustomMultiselectionWidget {
  ...
  Map<String, dynamic> toJson() {
    return _$$CustomMultiselectionWidgetImplToJson(this);
  }
}
