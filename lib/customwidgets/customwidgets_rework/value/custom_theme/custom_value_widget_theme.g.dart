...
_$CustomValueWidgetThemeImpl _$$CustomValueWidgetThemeImplFromJson(
    ...
    _$CustomValueWidgetThemeImpl(
      ...
      const MaterialColorConverter()
          .fromJson(json['valueTextColor'] as Map<String, dynamic>?),
      (json['valueTextFonSize'] as num?)?.toDouble(),
      const FontWeightConverter()
          .fromJson((json['valueTextFontWeight'] as num?)?.toInt()),
    );
...
Map<String, dynamic> _$$CustomValueWidgetThemeImplToJson(
    ...
    <String, dynamic>{
      ...
      'valueTextColor':
          const MaterialColorConverter().toJson(instance.valueTextColor),
      'valueTextFonSize': instance.valueTextFonSize,
      'valueTextFontWeight':
          const FontWeightConverter().toJson(instance.valueTextFontWeight),
    };
