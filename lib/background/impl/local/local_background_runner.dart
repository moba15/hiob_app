...
class LocalBackgroundRunnerImpl extends BackgroundRunner {
  static int i = 0;
  ...
  Future<void> start() async {
    ...
    if (!await shouldStart()) {
      talker
          ?.info("Background | startService | not started, shouldStart->false");
      return;
    }
  ...
  @override
  Future<bool> shouldStart() async {
    return NotificationManager.backgroundNotificationsEnabled;
  }
}
