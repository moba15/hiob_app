...
class ScreenListCubit extends Cubit<ScreenListState> {
  ...
  ScreenListCubit({required this.screenManager}) : super(const ScreenListState.loading()) {
    screenListSubscription = screenManager.screenStreamController.stream.listen((event) {update(event);});
  }
