...
class NotificationManager with WidgetsBindingObserver {
  ...
  static void init() async {
    ...
    CustomLogger.logInfoNotification(
      methodname: "init",
      logMessage: "before init awesomeNotifications",
    );
  ...
  void readSettings() async {
    ...
    Map<String, dynamic>? loadedSettings = await fileManager.getMap(
    ...
    if (loadedSettings == null) {
      ...
      for (Map<String, dynamic> customNotificationRaw
        ...
        notificationsLog.add(
          CustomNotification.fromJSON(customNotificationRaw),
        );
  ...
  void showIoBNotificationInForeground(String contentraw) {
    ...
    try {
      Map<String, dynamic> content = jsonDecode(contentraw);
      CustomNotification customNotification = CustomNotification.fromJSON(
        content,
      );
