...
class HistoryDataBloc extends Bloc<HistoryDataEvent, HistoryDataState> {
  ...
  HistoryDataBloc({required DataPoint dataPoint}) : super(HistoryDataState(historyData: dataPoint.historyData)) {

    _historyUpdateSubscription = dataPoint.historyData.streamController.stream.listen((event) {
