...
class LoginClient extends $grpc.Client {
  static final _$checkCompatibility = $grpc.ClientMethod<$1.CompatibilityRequest, $1.CompatibilityResponse>(
      '/Login/CheckCompatibility',
      ($1.CompatibilityRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.CompatibilityResponse.fromBuffer(value));
  ...
  static final _$requestApproval = $grpc.ClientMethod<$1.ApprovalRequest, $1.ApprovalResponse>(
      '/Login/RequestApproval',
      ($1.ApprovalRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.ApprovalResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.CompatibilityResponse> checkCompatibility($1.CompatibilityRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.ApprovalResponse> requestApproval($1.ApprovalRequest request, {$grpc.CallOptions? options}) {
...
abstract class LoginServiceBase extends $grpc.Service {
  ...
  LoginServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.CompatibilityRequest, $1.CompatibilityResponse>(
        'CheckCompatibility',
        checkCompatibility_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CompatibilityRequest.fromBuffer(value),
  ...
  $async.Future<$1.CompatibilityResponse> checkCompatibility_Pre($grpc.ServiceCall call, $async.Future<$1.CompatibilityRequest> request) async {
  ...
  $async.Future<$1.ApprovalResponse> requestApproval_Pre($grpc.ServiceCall call, $async.Future<$1.ApprovalRequest> request) async {
    return requestApproval(call, await request);
  }

  $async.Future<$1.CompatibilityResponse> checkCompatibility($grpc.ServiceCall call, $1.CompatibilityRequest request);
  $async.Future<$1.LoginResponse> login($grpc.ServiceCall call, $1.LoginRequest request);
  $async.Future<$1.ApprovalResponse> requestApproval($grpc.ServiceCall call, $1.ApprovalRequest request);
}
